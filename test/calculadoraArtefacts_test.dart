...
import '../Labs/SeparandoArtefatos/Key.dart';
import '../Labs/SeparandoArtefatos/KeyType.dart';
import '../Labs/SeparandoArtefatos/CalcAction.dart';
import '../Labs/SeparandoArtefatos/CalculatorController.dart';
//import '../Labs/SeparandoArtefatos/Display.dart';
...
void main() {
  test('add', () {
    ...
    calc.press(Key(label: '2', type: KeyType.digit));
    calc.press(
      Key(label: 'Enter', type: KeyType.action, action: CalcAction.enter),
    );
